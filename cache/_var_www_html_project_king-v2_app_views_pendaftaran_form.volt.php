    ...
    <div class="col-md-12">
      <div class="box box-danger">
        <div class="box-header">
          <a href="<?= $this->url->get('Pendaftaran/Pembayaran') ?>" class="btn btn-warning btn-flat pull-right" style="margin-left: 5px">New Student. Click Here!</a>
          <a href="<?= $this->url->get('Pendaftaran-ulang') ?>" class="btn btn-success btn-flat pull-right">Continuing Student. Click here!</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <form class="form-horizontal" id="pendaftaran" action="<?= $this->url->get('Pendaftaran/input') ?>" method="POST" data-remote>
            <!-- <div class="hidden" id="bayar-hidden"></div> -->
            <input type="hidden" name="tahap" value="1">
            <input type="hidden" name="status" id="status" value="">
            <input type="hidden" name="bayar" class="bayar1" value="">
            <input type="hidden" name="status_mulai" id="status_mulai" value="">
                  ...
                  <div class="box-body">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <select class="form-control" name="type_pembayaran" id="type_pembayaran" onchange="xx(this.value)">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="name_1" name="name" placeholder="nama Lengkap">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="fathers_name_1" name="fathers_name" placeholder="Nama Ayah">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="mothers_name_1" name="mothers_name" placeholder="Nama Ibu">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control phone_number" id="phone_number_1" name="phone_number" placeholder="08xxx" maxlength="13">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="col-sm-1"></label>
                        <label class="col-sm-2 ">Telp. / Hp Alternatif</label>

                        <div class="col-sm-8">
                          <input type="text" class="form-control phone_number" id="phone_number_alternative_1" name="phone_numbers_alt" placeholder="08xxx" maxlength="13">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="alamat_1"  name="c_alamat" placeholder="Jln.">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="dusun_1"  name="c_dusun" placeholder="Dusun">
                        </div>

                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="rt_1" name="c_rt" placeholder="RT">
                        </div>

                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="rw_1" name="c_rw" placeholder="RW">
                        </div>
                      </div>
                      ...
                      <div class="form-group" style="margin-bottom: 30px">
                        <label class="col-sm-3"></label>
                        <div class="col-sm-4">
                          <select class="form-control" name="c_prvns" onchange="filterKota(this.value)">
                        ...
                        <div class="col-sm-4">
                          <select class="form-control" id="kota" name="c_kota" onchange="filterKcmtn(this.value)">
                      ...
                      <div class="form-group">
                        <label class="col-sm-3"></label>
                        <div class="col-sm-4">
                          <select class="form-control" id="kcmtn" name="c_kcmtn" onchange="filterDesa(this.value)">
                            
                          </select>
                        </div>

                        <div class="col-sm-4">
                          <select class="form-control" id="desa" name="c_desa">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="zip_code_1"  name="c_zip_code" placeholder="Zip Code">
                        </div>
                      </div>
                      ...
                      <div id="persetujuan">
                        <h1 class="text-center">Ingin melanjutkan ke Pembayaran ?</h1>
